...
pub struct GattNameBook {
    ...
    /// which lookup a UUID wanted (decision 56).
...
impl GattNameBook {
    ...
    /// [`Self::get`] (decision 56). Same two sources, same precedence:
...
mod tests {
    ...
    /// decision 56: a service gets a name the same way a characteristic
