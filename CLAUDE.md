...
**Four files, not one.** Current truth: [spec.md](../embarch-doc/embarch-study-designer/spec.md). Why it is that way: [decisions.md](../embarch-doc/embarch-study-designer/decisions.md) — an index over `decisions/`, and a decision number addresses this sub-project, not a file. Unresolved: [open.md](../embarch-doc/embarch-study-designer/open.md). Reference: [interfaces/](../embarch-doc/embarch-study-designer/interfaces/).
